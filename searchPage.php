...
<body>
    ...
    if (isset($_POST['submit-search'])) {
        ...
        $sql = "select * from user where (user.fname = '$search'  OR user.email = '$search' OR user.hometown = '$search' OR user.number = '$search' OR user.lname = '$search') AND email <> '$user_email'";
